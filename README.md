...
- `time_ms` — integer milliseconds, `1 … 86400000` (24h). Runs claiming
  `reached_goal` must also be at least `MIN_WIN_TIME_MS` (30s by default) —
...
| `MIN_WIN_TIME_MS` | `30000` | Fastest believable prize win; faster `reached_goal` submits are rejected |
